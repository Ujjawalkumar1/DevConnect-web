const Footer = () => {
  return (
    <footer className="footer footer-center bg-base-200 text-neutral-content p-2 fixed bottom-0">
      <aside>
        <svg
          width="50"
          height="50"
        ...
        {/* <p className="font-bold">
          DevTinder
          <br />
          <h2 className="text-2xl">Connecting Developers</h2>     ----- ❌ This is invalid HTML
        </p> */}


        <p className="font-bold">DevTinder</p>
        <br />
